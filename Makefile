...
.PHONY: syntax-test-gen syntax-test-run

syntax-test-gen:
	(./script/dev-tools shell --command 'cabal run hstream-sql:syntax-test-runner -- -i gen ./hstream-sql/etc/syntax-test-cases.yaml')
...
syntax-test-run:
	(./script/dev-tools shell --command 'cabal run hstream-sql:syntax-test-runner -- run ./hstream-sql/etc/syntax-test-cases.yaml')
