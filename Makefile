...
syntax-test-gen:
	($(CABAL) run hstream-sql:syntax-test-runner -- -i gen ./hstream-sql/etc/syntax-test-cases.yaml)
...
syntax-test-run:
	($(CABAL) run hstream-sql:syntax-test-runner -- run ./hstream-sql/etc/syntax-test-cases.yaml)

plan-test-gen:
	($(CABAL) run hstream-sql:plan-test-runner -- -i gen ./hstream-sql/etc/plan-test-cases.yaml)
...
plan-test-run:
	($(CABAL) run hstream-sql:plan-test-runner -- run ./hstream-sql/etc/plan-test-cases.yaml)
