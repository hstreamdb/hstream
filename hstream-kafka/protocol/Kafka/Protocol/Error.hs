...
instance Show ErrorCode where
  show UNKNOWN_SERVER_ERROR                  = "UNKNOWN_SERVER_ERROR"
  show NONE                                  = "NONE"
  show OFFSET_OUT_OF_RANGE                   = "OFFSET_OUT_OF_RANGE"
  show CORRUPT_MESSAGE                       = "CORRUPT_MESSAGE"
  show UNKNOWN_TOPIC_OR_PARTITION            = "UNKNOWN_TOPIC_OR_PARTITION"
  show INVALID_FETCH_SIZE                    = "INVALID_FETCH_SIZE"
  show LEADER_NOT_AVAILABLE                  = "LEADER_NOT_AVAILABLE"
  show NOT_LEADER_OR_FOLLOWER                = "NOT_LEADER_OR_FOLLOWER"
  show REQUEST_TIMED_OUT                     = "REQUEST_TIMED_OUT"
  show BROKER_NOT_AVAILABLE                  = "BROKER_NOT_AVAILABLE"
  show REPLICA_NOT_AVAILABLE                 = "REPLICA_NOT_AVAILABLE"
  show MESSAGE_TOO_LARGE                     = "MESSAGE_TOO_LARGE"
  show STALE_CONTROLLER_EPOCH                = "STALE_CONTROLLER_EPOCH"
  show OFFSET_METADATA_TOO_LARGE             = "OFFSET_METADATA_TOO_LARGE"
  show NETWORK_EXCEPTION                     = "NETWORK_EXCEPTION"
  show COORDINATOR_LOAD_IN_PROGRESS          = "COORDINATOR_LOAD_IN_PROGRESS"
  show COORDINATOR_NOT_AVAILABLE             = "COORDINATOR_NOT_AVAILABLE"
  show NOT_COORDINATOR                       = "NOT_COORDINATOR"
  show INVALID_TOPIC_EXCEPTION               = "INVALID_TOPIC_EXCEPTION"
  show RECORD_LIST_TOO_LARGE                 = "RECORD_LIST_TOO_LARGE"
  show NOT_ENOUGH_REPLICAS                   = "NOT_ENOUGH_REPLICAS"
  show NOT_ENOUGH_REPLICAS_AFTER_APPEND      = "NOT_ENOUGH_REPLICAS_AFTER_APPEND"
  show INVALID_REQUIRED_ACKS                 = "INVALID_REQUIRED_ACKS"
  show ILLEGAL_GENERATION                    = "ILLEGAL_GENERATION"
  show INCONSISTENT_GROUP_PROTOCOL           = "INCONSISTENT_GROUP_PROTOCOL"
  show INVALID_GROUP_ID                      = "INVALID_GROUP_ID"
  show UNKNOWN_MEMBER_ID                     = "UNKNOWN_MEMBER_ID"
  show INVALID_SESSION_TIMEOUT               = "INVALID_SESSION_TIMEOUT"
  show REBALANCE_IN_PROGRESS                 = "REBALANCE_IN_PROGRESS"
  show INVALID_COMMIT_OFFSET_SIZE            = "INVALID_COMMIT_OFFSET_SIZE"
  show TOPIC_AUTHORIZATION_FAILED            = "TOPIC_AUTHORIZATION_FAILED"
  show GROUP_AUTHORIZATION_FAILED            = "GROUP_AUTHORIZATION_FAILED"
  show CLUSTER_AUTHORIZATION_FAILED          = "CLUSTER_AUTHORIZATION_FAILED"
  show INVALID_TIMESTAMP                     = "INVALID_TIMESTAMP"
  show UNSUPPORTED_SASL_MECHANISM            = "UNSUPPORTED_SASL_MECHANISM"
  show ILLEGAL_SASL_STATE                    = "ILLEGAL_SASL_STATE"
  show UNSUPPORTED_VERSION                   = "UNSUPPORTED_VERSION"
  show TOPIC_ALREADY_EXISTS                  = "TOPIC_ALREADY_EXISTS"
  show INVALID_PARTITIONS                    = "INVALID_PARTITIONS"
  show INVALID_REPLICATION_FACTOR            = "INVALID_REPLICATION_FACTOR"
  show INVALID_REPLICA_ASSIGNMENT            = "INVALID_REPLICA_ASSIGNMENT"
  show INVALID_CONFIG                        = "INVALID_CONFIG"
  show NOT_CONTROLLER                        = "NOT_CONTROLLER"
  show INVALID_REQUEST                       = "INVALID_REQUEST"
  show UNSUPPORTED_FOR_MESSAGE_FORMAT        = "UNSUPPORTED_FOR_MESSAGE_FORMAT"
  show POLICY_VIOLATION                      = "POLICY_VIOLATION"
  show OUT_OF_ORDER_SEQUENCE_NUMBER          = "OUT_OF_ORDER_SEQUENCE_NUMBER"
  show DUPLICATE_SEQUENCE_NUMBER             = "DUPLICATE_SEQUENCE_NUMBER"
  show INVALID_PRODUCER_EPOCH                = "INVALID_PRODUCER_EPOCH"
  show INVALID_TXN_STATE                     = "INVALID_TXN_STATE"
  show INVALID_PRODUCER_ID_MAPPING           = "INVALID_PRODUCER_ID_MAPPING"
  show INVALID_TRANSACTION_TIMEOUT           = "INVALID_TRANSACTION_TIMEOUT"
  show CONCURRENT_TRANSACTIONS               = "CONCURRENT_TRANSACTIONS"
  show TRANSACTION_COORDINATOR_FENCED        = "TRANSACTION_COORDINATOR_FENCED"
  show TRANSACTIONAL_ID_AUTHORIZATION_FAILED = "TRANSACTIONAL_ID_AUTHORIZATION_FAILED"
  show SECURITY_DISABLED                     = "SECURITY_DISABLED"
  show OPERATION_NOT_ATTEMPTED               = "OPERATION_NOT_ATTEMPTED"
  show KAFKA_STORAGE_ERROR                   = "KAFKA_STORAGE_ERROR"
  show LOG_DIR_NOT_FOUND                     = "LOG_DIR_NOT_FOUND"
  show SASL_AUTHENTICATION_FAILED            = "SASL_AUTHENTICATION_FAILED"
  show UNKNOWN_PRODUCER_ID                   = "UNKNOWN_PRODUCER_ID"
  show REASSIGNMENT_IN_PROGRESS              = "REASSIGNMENT_IN_PROGRESS"
  show DELEGATION_TOKEN_AUTH_DISABLED        = "DELEGATION_TOKEN_AUTH_DISABLED"
  show DELEGATION_TOKEN_NOT_FOUND            = "DELEGATION_TOKEN_NOT_FOUND"
  show DELEGATION_TOKEN_OWNER_MISMATCH       = "DELEGATION_TOKEN_OWNER_MISMATCH"
  show DELEGATION_TOKEN_REQUEST_NOT_ALLOWED  = "DELEGATION_TOKEN_REQUEST_NOT_ALLOWED"
  show DELEGATION_TOKEN_AUTHORIZATION_FAILED = "DELEGATION_TOKEN_AUTHORIZATION_FAILED"
  show DELEGATION_TOKEN_EXPIRED              = "DELEGATION_TOKEN_EXPIRED"
  show INVALID_PRINCIPAL_TYPE                = "INVALID_PRINCIPAL_TYPE"
  show NON_EMPTY_GROUP                       = "NON_EMPTY_GROUP"
  show GROUP_ID_NOT_FOUND                    = "GROUP_ID_NOT_FOUND"
  show FETCH_SESSION_ID_NOT_FOUND            = "FETCH_SESSION_ID_NOT_FOUND"
  show INVALID_FETCH_SESSION_EPOCH           = "INVALID_FETCH_SESSION_EPOCH"
  show LISTENER_NOT_FOUND                    = "LISTENER_NOT_FOUND"
  show TOPIC_DELETION_DISABLED               = "TOPIC_DELETION_DISABLED"
  show FENCED_LEADER_EPOCH                   = "FENCED_LEADER_EPOCH"
  show UNKNOWN_LEADER_EPOCH                  = "UNKNOWN_LEADER_EPOCH"
  show UNSUPPORTED_COMPRESSION_TYPE          = "UNSUPPORTED_COMPRESSION_TYPE"
  show STALE_BROKER_EPOCH                    = "STALE_BROKER_EPOCH"
  show OFFSET_NOT_AVAILABLE                  = "OFFSET_NOT_AVAILABLE"
  show MEMBER_ID_REQUIRED                    = "MEMBER_ID_REQUIRED"
  show PREFERRED_LEADER_NOT_AVAILABLE        = "PREFERRED_LEADER_NOT_AVAILABLE"
  show GROUP_MAX_SIZE_REACHED                = "GROUP_MAX_SIZE_REACHED"
  show FENCED_INSTANCE_ID                    = "FENCED_INSTANCE_ID"
  show ELIGIBLE_LEADERS_NOT_AVAILABLE        = "ELIGIBLE_LEADERS_NOT_AVAILABLE"
  show ELECTION_NOT_NEEDED                   = "ELECTION_NOT_NEEDED"
  show NO_REASSIGNMENT_IN_PROGRESS           = "NO_REASSIGNMENT_IN_PROGRESS"
  show GROUP_SUBSCRIBED_TO_TOPIC             = "GROUP_SUBSCRIBED_TO_TOPIC"
  show INVALID_RECORD                        = "INVALID_RECORD"
  show UNSTABLE_OFFSET_COMMIT                = "UNSTABLE_OFFSET_COMMIT"
  show THROTTLING_QUOTA_EXCEEDED             = "THROTTLING_QUOTA_EXCEEDED"
  show PRODUCER_FENCED                       = "PRODUCER_FENCED"
  show RESOURCE_NOT_FOUND                    = "RESOURCE_NOT_FOUND"
  show DUPLICATE_RESOURCE                    = "DUPLICATE_RESOURCE"
  show UNACCEPTABLE_CREDENTIAL               = "UNACCEPTABLE_CREDENTIAL"
  show INCONSISTENT_VOTER_SET                = "INCONSISTENT_VOTER_SET"
  show INVALID_UPDATE_VERSION                = "INVALID_UPDATE_VERSION"
  show FEATURE_UPDATE_FAILED                 = "FEATURE_UPDATE_FAILED"
  show PRINCIPAL_DESERIALIZATION_FAILURE     = "PRINCIPAL_DESERIALIZATION_FAILURE"
  show SNAPSHOT_NOT_FOUND                    = "SNAPSHOT_NOT_FOUND"
  show POSITION_OUT_OF_RANGE                 = "POSITION_OUT_OF_RANGE"
  show UNKNOWN_TOPIC_ID                      = "UNKNOWN_TOPIC_ID"
  show DUPLICATE_BROKER_REGISTRATION         = "DUPLICATE_BROKER_REGISTRATION"
  show BROKER_ID_NOT_REGISTERED              = "BROKER_ID_NOT_REGISTERED"
  show INCONSISTENT_TOPIC_ID                 = "INCONSISTENT_TOPIC_ID"
  show INCONSISTENT_CLUSTER_ID               = "INCONSISTENT_CLUSTER_ID"
  show TRANSACTIONAL_ID_NOT_FOUND            = "TRANSACTIONAL_ID_NOT_FOUND"
  show FETCH_SESSION_TOPIC_ID_ERROR          = "FETCH_SESSION_TOPIC_ID_ERROR"
  show INELIGIBLE_REPLICA                    = "INELIGIBLE_REPLICA"
  show NEW_LEADER_ELECTED                    = "NEW_LEADER_ELECTED"
  show OFFSET_MOVED_TO_TIERED_STORAGE        = "OFFSET_MOVED_TO_TIERED_STORAGE"
  show FENCED_MEMBER_EPOCH                   = "FENCED_MEMBER_EPOCH"
  show UNRELEASED_INSTANCE_ID                = "UNRELEASED_INSTANCE_ID"
  show UNSUPPORTED_ASSIGNOR                  = "UNSUPPORTED_ASSIGNOR"
