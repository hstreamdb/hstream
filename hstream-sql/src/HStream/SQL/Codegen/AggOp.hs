...
op_max (FlowDate acc_x) (FlowDate row_x) = Right . FlowDate $ max acc_x row_x
op_max (FlowDate _) _ = Left . ERR $ "Max: type mismatch (expect a date value)"
op_max (FlowTime acc_x) (FlowTime row_x) = Right $ FlowTime (max acc_x row_x)
op_max (FlowTime _) _ = Left $ ERR "Max: type mismatch (expect a time value)"
op_max (FlowTimestamp acc_x) (FlowTimestamp row_x) = Right $ FlowTimestamp (max acc_x row_x)
op_max (FlowTimestamp _) _ = Left $ ERR "Max: type mismatch (expect a timestamp value)"
op_max (FlowInterval acc_x) (FlowInterval row_x) = Right $ FlowInterval (max acc_x row_x)
op_max (FlowInterval _) _ = Left $ ERR "Max: type mismatch (expect a interval value)"
...
op_min (FlowDate acc_x) (FlowDate row_x) = Right . FlowDate $ min acc_x row_x
op_min (FlowDate _) _ = Left . ERR $ "Min: type mismatch (expect a date value)"
op_min (FlowTime acc_x) (FlowTime row_x) = Right $ FlowTime (min acc_x row_x)
op_min (FlowTime _) _ = Left $ ERR "Min: type mismatch (expect a time value)"
op_min (FlowTimestamp acc_x) (FlowTimestamp row_x) = Right $ FlowTimestamp (min acc_x row_x)
op_min (FlowTimestamp _) _ = Left $ ERR "Min: type mismatch (expect a timestamp value)"
op_min (FlowInterval acc_x) (FlowInterval row_x) = Right $ FlowInterval (min acc_x row_x)
op_min (FlowInterval _) _ = Left $ ERR "Min: type mismatch (expect a interval value)"
...
aggMergeOnValue (Unary AggMax _) k (FlowDate  n1) (FlowDate  n2) = Right $ FlowDate  (max n1 n2)
aggMergeOnValue (Unary AggMax _) k (FlowTime  n1) (FlowTime  n2) = Right $ FlowTime  (max n1 n2)
aggMergeOnValue (Unary AggMax _) k (FlowTimestamp n1) (FlowTimestamp n2) = Right $ FlowTimestamp (max n1 n2)
aggMergeOnValue (Unary AggMax _) k (FlowInterval n1) (FlowInterval n2) = Right $ FlowInterval (max n1 n2)
...
aggMergeOnValue (Unary AggMin _) k (FlowDate  n1) (FlowDate  n2) = Right $ FlowDate  (min n1 n2)
aggMergeOnValue (Unary AggMin _) k (FlowTime  n1) (FlowTime  n2) = Right $ FlowTime  (min n1 n2)
aggMergeOnValue (Unary AggMin _) k (FlowTimestamp n1) (FlowTimestamp n2) = Right $ FlowTimestamp (min n1 n2)
aggMergeOnValue (Unary AggMin _) k (FlowInterval n1) (FlowInterval n2) = Right $ FlowInterval (min n1 n2)
