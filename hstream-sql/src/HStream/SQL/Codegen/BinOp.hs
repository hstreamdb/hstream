...
op_eq v1 v2 = Left . ERR $ "Unsupported operator <eq> on value <" <> T.pack (show v1) <> "> and <" <> T.pack (show v2) <> ">"
...
op_chunksOf (FlowNumeral n) (FlowText xs) =
  case toBoundedInteger n of
    ...
    Nothing -> Left . ERR $ "Operation <chunksOf> on chunks of size " <> T.pack (show n) <> " is not supported"
...
op_take (FlowNumeral n) (FlowText xs) =
  case toBoundedInteger n of
    ...
    Nothing -> Left . ERR $ "Operation <take> on size " <> T.pack (show n) <> " is not supported"
...
op_takeEnd (FlowNumeral n) (FlowText xs) =
  case toBoundedInteger n of
    ...
    Nothing -> Left . ERR $ "Operation <takeEnd> on size " <> T.pack (show n) <> " is not supported"
...
op_drop (FlowNumeral n) (FlowText xs) =
  case toBoundedInteger n of
    ...
    Nothing -> Left . ERR $ "Operation <drop> on size " <> T.pack (show n) <> " is not supported"
...
op_dropEnd (FlowNumeral n) (FlowText xs) =
  case toBoundedInteger n of
    ...
    Nothing -> Left . ERR $ "Operation <dropEnd> on size " <> T.pack (show n) <> " is not supported"
