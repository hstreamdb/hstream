...
module HStream.SQL.Codegen.CommonNew where
...
genAggregateComponent agg cata = case agg of
  Nullary nAgg ->
    ...
    , aggregateF    = \acc _ ->
        case getField (0,columnId cata) acc of
          Just (k, acc_v) ->
    ...
    , aggregateMergeF = \k o1 o2 ->
        case getField (0,columnId cata) o1 of
          Just (_,v1) ->
            case getField (0,columnId cata) o2 of
              Just (_,v2) ->
