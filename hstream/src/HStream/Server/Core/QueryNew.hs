...
module HStream.Server.Core.QueryNew (
...
#else
      parseAndBind createQueryRequestSql >>= \bSQL -> case bSQL of
...
{-
        BoundQInsert (BoundInsertSel streamName rSel) -> do
          (hstreamCodegen $ BoundQInsert (BoundInsertSel
